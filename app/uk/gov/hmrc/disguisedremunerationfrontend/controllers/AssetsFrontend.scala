...
object AssetsFrontend extends InferForm{
  ...
  def compoundField(key: String, values: Input, errors: ErrorTree, messages: Messages)(inner: Html): Html = html.compoundfield(key, errors, messages)(inner)

  def soloField(key: String, values: Input,errors: ErrorTree,messages: Messages)(ask: Html)(tell: Html): Html = html.standardfield(key, errors, messages)(ask)(tell)
